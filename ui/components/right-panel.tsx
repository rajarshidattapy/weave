...
export function RightPanel() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        layout
        className={`flex flex-1 w-full flex-col rounded-2xl border border-white/10 bg-black overflow-hidden shadow-2xl ${
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-white/10 bg-black/60 px-4 py-3 backdrop-blur-sm">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-white/60 font-medium">localhost:3001</span>
          </div>
          <div className="flex items-center gap-2">
